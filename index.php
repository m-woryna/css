...
<meta name="keywords" content="turystyka, atrakcje, ciekawe miejsca do zwiedzania, katalog stron turystycznych, strony turystyczne, ciekawe strony o turystyce, serwisy turystyczne, serwisy hotelarskie, noclegi, biura podróży, agencje turystyczne, internetowe przewodniki turystyczne, podróże, agrowczasy, intervac, podróżnicy,  wakacje, wycieczki, trekking, wyprawy,  uzdrowiska, sanatoria, ciekawe linki, ciekawe strony, przydatne strony, katalog stron internetowych ">
<meta name="description" content="turystyka, atrakcje, ciekawe miejsca do zwiedzania, katalog stron turystycznych, strony turystyczne, ciekawe strony o turystyce, serwisy turystyczne, serwisy hotelarskie, noclegi, biura podróży, agencje turystyczne, internetowe przewodniki turystyczne, podróże, agrowczasy, intervac, podróżnicy,  wakacje, wycieczki, trekking, wyprawy,  uzdrowiska, sanatoria, ciekawe linki, ciekawe strony, przydatne strony, katalog stron internetowych">

</head>
<title>Turystyka - atrakcje, ciekawe miejsca do zwiedzania, katalog stron turystycznych, ciekawe strony, przydatne linki</title>
...
require 'teksty/turystyka_atrakcje_news1.php';
...
require 'linki_turystyczne/plink_beskid_slaski.php';
require 'linki_turystyczne/plink_beskid_niski.php';
require 'linki_turystyczne/plink_krakow.php';
require 'linki_turystyczne/plink_litwa.php';
require 'linki_turystyczne/plink_zamosc.php';
require 'linki_turystyczne/plink_wieden.php';
require 'menu_prawe.php';
require 'linki_turystyczne/plink_swinoujscie.php';
require 'linki_turystyczne/plink_kaszuby.php';
require 'linki_turystyczne/plink_miedzywodzie.php';
print '<br>';
print $r_kwad;
print '<br>';
require 'linki_turystyczne/plink_miedzyzdroje.php';
require 'linki_turystyczne/plink_bieszczady.php';
...
if(!(file_exists("liczba_turys.txt"))) { //nie ma pliku z licznikiem 
     $plik_l=fopen("liczba_turys.txt","w+");
	 fputs($plik_l,"0");
	 fclose ($plik_l);
	 }
  $plik_l=fopen("liczba_turys.txt","r+");	 
  if(!($plik_l)) {
